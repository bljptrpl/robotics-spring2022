...
void servo()
{
  ...
  display.setTextColor(WHITE);
  display.setCursor(0,0);
  display.println("This is fine.");
  display.display();
  //delay(2000);

  // display.clearDisplay();
  // display.drawBitmap(0, 0, ThisisFine, 128, 32, WHITE); 
  // display.display();
  // //delay(3000);
...
void shortcut()
{
  ...
  display.setTextColor(WHITE);
  display.setCursor(0,0);
  display.println("Taking Shortcut!");
  display.display();
}
void ubermensch()
{
  ...
  case 8: servo(); break;
  case 9: ROUTE = TWO_SHORT_START; shortcut(); route(); break;
  case 10: globalstep = 0; break;
  case 11: servo(); break;
  case 12: ROUTE = THREE_LONG_DEL; route(); break;
  case 13: globalstep = 0; break;
  case 14: ROUTE = THREE_SHORT_START; shortcut(); route(); break;
